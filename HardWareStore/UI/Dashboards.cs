...
namespace MedicineShop
{
    public partial class Dashboards : Form
    {
        ...
        public static Dashboards Instance { get; private set; }
        public Dashboards()
        {
            InitializeComponent();
        ...
        {
            var f = Program.ServiceProvider.GetRequiredService<InventoryMain>();
            LoadFormIntoPanel(f);
        }
        ...
        {
            var f = new PurchaseBatchManagementForm();
           LoadFormIntoPanel(f);
        }
        ...
        {
            var f = Program.ServiceProvider.GetRequiredService<AddPurchaseBatchForm>();
            LoadFormIntoPanel(f);
        }
